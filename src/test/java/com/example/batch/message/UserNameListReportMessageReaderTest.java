...
class UserNameListReportMessageReaderTest {
    ...
    void receive() {
        ...
        UserNameListReportRequestMessage message = new UserNameListReportRequestMessage(
                "request-1",
        ...
        Optional<UserNameListReportRequestMessage> actual =
        ...
        verify(rabbitTemplate).receiveAndConvert(
                eq("report.queue"),
                ArgumentMatchers.<ParameterizedTypeReference<UserNameListReportRequestMessage>>any()
        );
